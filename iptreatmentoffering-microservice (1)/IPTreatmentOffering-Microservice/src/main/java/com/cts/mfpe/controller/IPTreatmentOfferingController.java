...
//import com.cts.mfpe.IpTreatmentOfferingApplication;
...
public class IPTreatmentOfferingController {
	...
	public List<SpecialistDetail> getAllSpecialistByAilmentCategory(
			@ApiParam(name = "ailment", value = "area of expertise") @PathVariable String ailment,
			@RequestHeader(value = "Authorization", required = true) String requestTokenHeader)
